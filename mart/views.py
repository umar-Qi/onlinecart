...
stripe.api_key = "sk_test_51GzMp5F7fzMNQj7XfR4Pn1VWVD1fSUvwSENR4pgSfiklMzgYqpmiaYNPsQlox6boAW7xfuUTRTbGtqNFL4Z36nnN002Y4OEbiv"
...
def search(request):
    ...
    return render(request, 'mart/search.html', params)
...
def contact(request):
    ...
    if request.method=="POST":
            ...
            contact = ClientInfo(name=name, email=email, phone=phone, desc=desc)
            contact.save()
    thank = True
...
def proview(request, myid):
    ...
    print(pro)
    return render(request, 'mart/proview.html', {'product': pro[0]})
